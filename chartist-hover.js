      ...
      return function tooltip(chart) {
        ...
        function init() {
          ...
          chart.container.addEventListener(
            "mouseover",
            delegate(triggerSelector, function(e) {
        ...
        function showTooltip(triggerElement) {
          ...
          seriesGroups = Array.prototype.slice.call(
            triggerElement.parentNode.parentNode.children
          );
          seriesIndex = options.dataDrawnReversed
            ? seriesGroups.reverse().indexOf(triggerElement.parentNode)
            : seriesGroups.indexOf(triggerElement.parentNode);

          valueGroup = Array.prototype.slice.call(
            triggerElement.parentNode.querySelectorAll(
          ...
          var activeTriggerElements = chart.container.querySelectorAll(
            "." + hoverClass
          );
          Array.prototype.forEach.call(activeTriggerElements, function(
          ...
          if (meta && typeof meta === "object") {
            for (var metaKey in meta) {
              textMarkup = textMarkup.replace(
                new RegExp("{{" + metaKey + "}}", "gi"),
                meta[metaKey] || ""
              );
            }
          } else {
        ...
        function createTooltipElement() {
          ...
          if (options.elementTemplateSelector) {
            tooltipTemplateElement = document.querySelector(
              options.elementTemplateSelector
            );
        ...
        function setTooltipPosition(relativeElement, ignoreClasses) {
          ...
          tooltipElement.classList.add(
            options.cssClass + "--" + positionData.alignment
          );
        }
